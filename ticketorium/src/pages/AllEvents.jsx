...
function AllEvents(props) {
    ...
    const username = props.user.handle || null;
    ...
    useEffect(() => {
        ...
        async function loadAll() {
            ...
            try {
                // ---------- 1) Fetch events for this university ----------
                const backendEvents = await fetchEvents({}, props.user);

                // ---------- 2) Fetch registrations for this backend user ----------
                let regs = [];
                if (props.user._id) {
                    try {
                        regs = await fetchUserRegistrations(props.user._id);
                    } catch (e) {
                        console.error(
                ...
                // ---------- 3) Build events map: eventId → event object ----------
                const eventsMap = {};
                ...
                // ---------- 4) Build eventsJoined in legacy shape ----------
                ...
                regs.forEach((reg) => {
                    ...
                    const uniCode =
                        typeof uni === "string" ? uni : uni?.code || uni?.name || props.user.universityCode || "";
                ...
                props.filterContent(
                    ...
                    "",
                    {
                        ...
                        university: props.user.universityCode,
    ...
    }, [props.user.universityCode, username, props.filterContent]);
