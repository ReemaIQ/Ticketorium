...
function AllEvents() {
    ...
    const getEventsTitle = (type) => {
        ...
        if (t === "admin") {
            return <span className="font-[Gilroy] font-black text-[40px] text-[#1A1A1A]" >Manage Events</span>;
        }
        ...
        if (t === "student") {
            return <span className="font-[Gilroy] font-black text-[40px] text-[#1A1A1A]">Events</span>;
        }
